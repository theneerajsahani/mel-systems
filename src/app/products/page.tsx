        ...
        <div className="py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Discover our comprehensive range of industrial solutions designed
          ...
          <div className="flex flex-col lg:flex-row py-12 sm:py-16 md:py-20 border-t border-border items-start lg:items-center gap-8 lg:gap-16">
            ...
            <div className="flex flex-col gap-4 md:gap-6 lg:w-80 xl:w-96 flex-shrink-0">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                Advanced oil quality monitoring and conditioning solutions to
                ensure optimal equipment performance and longevity.
              </p>
              <Link
                ...
                <CarouselContent className="-ml-2 sm:-ml-4">
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          tandeltaCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          hydrotechnikCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          filtertechnikCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          evamoSmartBubbleSystemData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row py-12 sm:py-16 md:py-20 border-t border-border items-start lg:items-center gap-8 lg:gap-16">
            ...
            <div className="flex flex-col gap-4 md:gap-6 lg:w-80 xl:w-96 flex-shrink-0">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                Complete camera and monitoring systems for enhanced visibility
                ...
                <CarouselContent className="-ml-2 sm:-ml-4">
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          rearViewCamerasCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          frontCameraSystemCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                        name="Front Camera"
                      />
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          digitalCamerasCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                        name="Digital Camera"
                      />
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          monitorsCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                        name="Monitor"
                      />
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          digitalMonitorsCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          forkCamerasCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                        name="Fork Camera"
                      />
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="h-[320px] w-[280px]">
                      <ProductCard
                        image={
                          videoControlUnitsCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="">
                      <ProductCard
                        image={
                          craneCamerasCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                        name="Crane Camera"
                      />
                  ...
                  <CarouselItem className="pl-4 sm:pl-10">
                    <div className="">
                      <ProductCard
                        image={
                          transmissionsCategoryData.images?.[0]?.src ||
                          "/fallback.jpg"
                        }
                        name="Transmissions"
                      />
        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Our team of experts can help you find the perfect products for
