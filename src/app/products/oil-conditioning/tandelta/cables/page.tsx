    ...
    <ProductLayout breadcrumbItems={breadcrumbItems}>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-600 leading-relaxed">
          Complete range of cables for TanDelta oil condition monitoring
          systems. Each cable type is designed for specific applications and
          environments.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="prose max-w-none text-gray-600">
          <p className="mb-4">
            TanDelta offers a comprehensive range of cables designed to meet the
            specific requirements of oil condition monitoring applications. Each
            cable type is engineered for optimal performance in different
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <strong>Cable J:</strong> Configuration cables for initial
                  setup and programming
                </li>
                <li>
                  <strong>Cable X:</strong> In-service configuration cables for
                  live system adjustments
                </li>
                <li>
                  <strong>Cable M:</strong> Supply cables for standard
                  in-service applications
                </li>
                <li>
                  <strong>Cable HP:</strong> High-pressure rated cables for
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <strong>Cable BBHaz:</strong> Hazardous area certified gateway
                  data cables
                </li>
                <li>
                  <strong>Cable BBSt:</strong> Standard gateway data cables for
                  general applications
                </li>
                <li>
                  <strong>Cable DB:</strong> Display to base bridge connection
                  cables
                </li>
                <li>
                  <strong>Cable HB:</strong> Gateway hub to base bridge
                  connection cables
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <strong>Cable GH:</strong> Gateway hub to gateway connection
                  cables
                </li>
                <li>
                  <strong>Cable SD:</strong> Sensor to display connection cables
                </li>
                <li>
                  <strong>Cable SB:</strong> Sensor to base bridge connection
                  cables
                </li>
                <li>
                  <strong>Cable SH:</strong> Sensor to hub connection cables
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <strong>Cable HH:</strong> Gateway hub to hub connection
                  cables
                </li>
                <li>
                  <strong>Cable HCP-1:</strong> Gateway hub community plug
                  connectors
                </li>
              </ul>
            </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Most cables are available in multiple
              lengths (1m, 3m, 5m) to accommodate various installation
              requirements. Each cable is designed with specific connectors and
              materials optimized for its intended application. Contact our
              technical team for assistance with cable selection for your
