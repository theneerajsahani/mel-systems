...
const tandeltaProducts: ProductInfo[] = [
  {
    ...
    description:
      "Real-time oil quality monitoring with molecular-level precision and FSH™ technology",
  ...
  },
  {
    ...
    image:
      "/products/oil conditioning/Tandelta/OQSx-G2 HAZ Oil Quality Sensor/OQSx-G2 HAZ Oil Quality Sensor.jpg",
    description:
      "Hazardous area certified oil quality sensor for extreme environments",
    category: "Oil Quality Sensors",
    features: [
  ...
  },
  {
    ...
    image:
      "/products/oil conditioning/Tandelta/OQDe-G2 Display Express/OQDe-G2 Display Express.jpg",
    description:
      "Intuitive display system for real-time oil quality visualization",
  ...
  },
  {
    ...
    description:
      "Central hub for multiple sensor connections and data management",
    category: "Gateway Systems",
    features: [
  ...
  },
  {
    ...
    image:
      "/products/oil conditioning/Tandelta/OQSX-G2 Sensor kit/OQSX-G2 Sensor kit.jpg",
    description:
      "Complete sensor kit with all necessary components for installation",
    category: "Oil Quality Sensors",
  ...
  },
  {
    ...
    image:
      "/products/oil conditioning/Tandelta/SENSE2 Display Kit/SENSE2 Display Kit.jpg",
    description:
      "Advanced display kit for comprehensive oil monitoring visualization",
    category: "Display Systems",
    features: [
  ...
  },
  {
    ...
    image:
      "/products/oil conditioning/Tandelta/SENSE3 Gateway Kit/SENSE3 Gateway Kit.jpg",
    description:
      "Next-generation gateway kit for enhanced connectivity and monitoring",
    category: "Gateway Systems",
    features: [
  ...
  },
  {
    ...
    description:
      "High-quality cables for sensor connections and data transmission",
    category: "Manifolds & Cables",
    features: [
...
const categories = [
  { name: "All Products", value: "all", count: tandeltaProducts.length },
  {
    ...
    value: "sensors",
    count: tandeltaProducts.filter((p) => p.category === "Oil Quality Sensors")
      .length,
  },
  {
    name: "Display Systems",
    value: "displays",
    count: tandeltaProducts.filter((p) => p.category === "Display Systems")
      .length,
  },
  {
    name: "Gateway Systems",
    value: "gateways",
    count: tandeltaProducts.filter((p) => p.category === "Gateway Systems")
      .length,
  },
  {
    name: "Mobile Test Kits",
    value: "mobile",
    count: tandeltaProducts.filter((p) => p.category === "Mobile Test Kits")
      .length,
  },
  {
    name: "Manifolds & Cables",
    value: "manifolds",
    count: tandeltaProducts.filter((p) => p.category === "Manifolds & Cables")
      .length,
  },
];
  ...
  const filteredProducts = tandeltaProducts.filter((product) => {
    ...
    const matchesCategory =
      ...
      (selectedCategory === "sensors" &&
        product.category === "Oil Quality Sensors") ||
      (selectedCategory === "displays" &&
        product.category === "Display Systems") ||
      (selectedCategory === "gateways" &&
        product.category === "Gateway Systems") ||
      (selectedCategory === "mobile" &&
        product.category === "Mobile Test Kits") ||
      (selectedCategory === "manifolds" &&
        product.category === "Manifolds & Cables");
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed mb-8">
                  Advanced real-time oil quality analysis sensors with
                  molecular-level detection and FSH™ core technology. Leading
                  innovation in predictive maintenance and equipment protection.
                </p>
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto pb-16">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Showing {filteredProducts.length} of {tandeltaProducts.length}{" "}
            products
          </p>
        </div>
      ...
      <div className="bg-gradient-to-r from-primary/5 to-blue-500/5 py-16">
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-5xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Our experts can help you select the perfect oil quality monitoring
