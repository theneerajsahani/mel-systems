...
const hydrotechnikProducts: ProductInfo[] = [
    {
        ...
        description: 'Wireless monitoring solution with Bluetooth connectivity for real-time data collection',
        category: 'Wireless Monitoring',
        features: ['Bluetooth connectivity', 'Mobile app integration', 'Real-time monitoring'],
        isFeatured: true
    },
    {
        ...
        description: 'Advanced data visualization software for comprehensive analysis and reporting',
        category: 'Software Solutions',
        features: ['Data visualization', 'CSV import/export', 'Advanced analytics']
    },
    {
        ...
        description: 'Professional-grade remote monitoring system for industrial applications',
        category: 'Remote Monitoring',
        features: ['Professional grade', 'Remote access', 'Industrial applications'],
        isFeatured: true
    },
    {
        ...
        description: 'Multi-parameter wireless sensors for comprehensive hydraulic system monitoring',
        category: 'Wireless Sensors',
        features: ['Multi-parameter sensing', 'Wireless technology', 'Hydraulic monitoring'],
        isNew: true
    },
    {
        id: 'watchlog-usb',
        ...
        description: 'USB-based data logging solution for portable monitoring applications',
        category: 'Data Loggers',
        features: ['USB connectivity', 'Portable design', 'Data logging']
    }
];

const categories = [
    { name: 'All Products', value: 'all', count: hydrotechnikProducts.length },
    { name: 'Wireless Monitoring', value: 'wireless', count: hydrotechnikProducts.filter(p => p.category === 'Wireless Monitoring').length },
    { name: 'Remote Monitoring', value: 'remote', count: hydrotechnikProducts.filter(p => p.category === 'Remote Monitoring').length },
    { name: 'Wireless Sensors', value: 'sensors', count: hydrotechnikProducts.filter(p => p.category === 'Wireless Sensors').length },
    { name: 'Software Solutions', value: 'software', count: hydrotechnikProducts.filter(p => p.category === 'Software Solutions').length },
    { name: 'Data Loggers', value: 'loggers', count: hydrotechnikProducts.filter(p => p.category === 'Data Loggers').length }
];
...
export default function HydrotechnikPage() {
    ...
    const filteredProducts = hydrotechnikProducts.filter(product => {
        ...
        const matchesCategory = selectedCategory === 'all' || 
            (selectedCategory === 'wireless' && product.category === 'Wireless Monitoring') ||
            (selectedCategory === 'remote' && product.category === 'Remote Monitoring') ||
            (selectedCategory === 'sensors' && product.category === 'Wireless Sensors') ||
            (selectedCategory === 'software' && product.category === 'Software Solutions') ||
            (selectedCategory === 'loggers' && product.category === 'Data Loggers');
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div className="text-center p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-white/20">
                                        <div className="text-2xl font-bold text-blue-500 mb-1">Multi</div>
                                        <div className="text-sm text-muted-foreground">Parameter</div>
                                    </div>
                                    <div className="text-center p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-white/20">
                                        <div className="text-2xl font-bold text-blue-500 mb-1">Real-time</div>
