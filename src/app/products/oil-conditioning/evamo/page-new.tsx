...
import { ArrowLeft, Droplet, Star, Settings, Wrench, Clock, Phone, Mail, ExternalLink, Search } from 'lucide-react';
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed mb-8">
                                    Specialized oil conditioning and management solutions for industrial applications. 
                                    Expert provider of high-quality equipment and services for optimal fluid management.
                                </p>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="text-center p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-white/20">
                                        <div className="text-2xl font-bold text-purple-500 mb-1">Expert</div>
                                        <div className="text-sm text-muted-foreground">Solutions</div>
                                    </div>
                                    <div className="text-center p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-white/20">
                                        <div className="text-2xl font-bold text-purple-500 mb-1">Custom</div>
                                        <div className="text-sm text-muted-foreground">Engineering</div>
                                    </div>
                                    <div className="text-center p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-white/20">
                                        <div className="text-2xl font-bold text-purple-500 mb-1">Quality</div>
            ...
            <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto py-16">
                <div className="text-center">
                    ...
                    <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
                        We're currently updating our Evamo product catalog. Please contact our experts 
                        for information about available solutions and custom engineering services.
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <Card className="p-6 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Tailored oil conditioning systems designed for your specific requirements
                            </p>
                        </Card>
                        ...
                        <Card className="p-6 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                High-quality equipment and solutions backed by industry expertise
                            </p>
                        </Card>
                    </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-purple-500/5 to-indigo-500/5 py-16">
                <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-muted-foreground text-lg mb-8">
                        Our Evamo experts specialize in custom engineering and can develop the perfect solution for your unique requirements
                    </p>
