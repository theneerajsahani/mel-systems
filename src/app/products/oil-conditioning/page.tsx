...
import { ArrowRight, Zap, Droplet, Filter, Leaf, Search, Star, Shield, TrendingUp, Clock, Phone, Mail, ExternalLink } from 'lucide-react';
...
const manufacturers: Manufacturer[] = [
    {
        id: 'tandelta',
        name: 'TanDelta',
        description: 'Advanced real-time oil quality analysis sensors with molecular-level detection and FSH™ core technology.',
        ...
        categories: [
            { 
                ...
                productCount: 3,
                image: '/products/oil conditioning/Tandelta/OQSx-G2 Oil Quality Sensor/OQSx-G2 Oil Quality Sensor-1.jpg',
                description: 'Real-time oil condition monitoring with molecular-level precision'
            },
            { 
                name: 'Display Systems', 
                href: '/products/oil-conditioning/tandelta/oqde-g2-display-express', 
                productCount: 2,
                image: '/products/oil conditioning/Tandelta/OQDe-G2 Display Express/OQDe-G2 Display Express.png',
    ...
    },
    {
        id: 'hydrotechnik',
        name: 'Hydrotechnik',
        description: 'Comprehensive monitoring solutions for pressure, temperature, and flow with wireless connectivity.',
    ...
    },
    {
        id: 'filtertechnik',
        name: 'Filtertechnik',
        description: 'Digital imaging particle counters and portable oil analysis solutions for precise contamination detection.',
    ...
    },
    {
        id: 'evamo',
        name: 'Evamo',
        description: 'Sustainable oil conditioning solutions focused on environmental responsibility and eco-friendly approaches.',
...
export default function OilConditioningPage() {
    ...
    const filteredManufacturers = manufacturers.filter(manufacturer => {
        const matchesSearch = searchTerm === '' || 
            ...
            manufacturer.categories.some(cat => cat.name.toLowerCase().includes(searchTerm.toLowerCase()));

        const matchesCategory = selectedCategory === 'all' || 
            (selectedCategory === 'sensors' && manufacturer.categories.some(cat => cat.name.toLowerCase().includes('sensor'))) ||
            (selectedCategory === 'monitoring' && manufacturer.categories.some(cat => cat.name.toLowerCase().includes('monitor') || cat.name.toLowerCase().includes('bluetooth') || cat.name.toLowerCase().includes('wireless'))) ||
            (selectedCategory === 'analysis' && manufacturer.categories.some(cat => cat.name.toLowerCase().includes('analysis') || cat.name.toLowerCase().includes('counter') || cat.name.toLowerCase().includes('test'))) ||
            (selectedCategory === 'eco-friendly' && manufacturer.categories.some(cat => cat.name.toLowerCase().includes('eco') || cat.name.toLowerCase().includes('sustainable')));
    ...
    const categories = [
        ...
        { value: 'sensors', label: 'Sensors', count: manufacturers.filter(m => m.categories.some(cat => cat.name.toLowerCase().includes('sensor'))).length },
        { value: 'monitoring', label: 'Monitoring', count: manufacturers.filter(m => m.categories.some(cat => cat.name.toLowerCase().includes('monitor') || cat.name.toLowerCase().includes('bluetooth') || cat.name.toLowerCase().includes('wireless'))).length },
        { value: 'analysis', label: 'Analysis', count: manufacturers.filter(m => m.categories.some(cat => cat.name.toLowerCase().includes('analysis') || cat.name.toLowerCase().includes('counter') || cat.name.toLowerCase().includes('test'))).length },
        { value: 'eco-friendly', label: 'Eco-Friendly', count: manufacturers.filter(m => m.categories.some(cat => cat.name.toLowerCase().includes('eco') || cat.name.toLowerCase().includes('sustainable'))).length }
    ];
                    ...
                    <div className="py-12 md:py-20">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-8">
                                Advanced oil quality monitoring and conditioning systems from leading manufacturers. 
                                Extend equipment life, reduce maintenance costs, and optimize performance with real-time analysis.
                            </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                            <div className="text-center p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 hover:scale-105 transition-transform duration-300">
                                ...
                                <div className="text-sm text-muted-foreground font-medium">Trusted Manufacturers</div>
                            </div>
                            <div className="text-center p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 hover:scale-105 transition-transform duration-300">
                            ...
                            <div className="text-center p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 hover:scale-105 transition-transform duration-300">
                                ...
                                <div className="text-sm text-muted-foreground font-medium">Equipment Life Extension</div>
                            </div>
                            <div className="text-center p-6 rounded-xl bg-white/50 backdrop-blur-sm border border-white/20 hover:scale-105 transition-transform duration-300">
                                <div className="text-3xl font-bold text-primary mb-2">60%</div>
                                <div className="text-sm text-muted-foreground font-medium">Maintenance Cost Reduction</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6 mb-8">
                    <div className="flex flex-col md:flex-row gap-4 items-center">
                        <div className="relative flex-1">
                            ...
                            <input
                                type="text"
                                placeholder="Search manufacturers, products, or technologies..."
            ...
            <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto pb-16">
                <div className="mb-12">
                    ...
                    <p className="text-muted-foreground text-lg mb-6">
                        Explore products and solutions from industry-leading technology providers
                    </p>
                </div>
                ...
                <div className="space-y-16">
                    {filteredManufacturers.map((manufacturer) => {
                        ...
                        const totalProducts = manufacturer.categories.reduce((total, cat) => total + cat.productCount, 0);
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center gap-6 text-sm">
                                                <div className="flex items-center gap-2 text-muted-foreground">
                                                    ...
                                                    <span>{manufacturer.categories.length} Product Categories</span>
                                                </div>
                                                <div className="flex items-center gap-2 text-muted-foreground">
                                        ...
                                        <CarouselContent className="-ml-4">
                                            {manufacturer.categories.map((category) => (
                                                <CarouselItem key={category.name} className="pl-4 md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                                                    <Link href={category.href} className="block h-full group">
                                                        <Card className="h-full border-2 hover:border-primary/50 transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-1 overflow-hidden">                                            {/* Product Image */}
                                            <div className="relative h-48 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
                                                ...
                                                <div className="absolute top-3 right-3">
                                                    <Badge variant={category.productCount > 0 ? "default" : "secondary"} className="text-xs">
                ...
                {filteredManufacturers.length === 0 && (
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-xl font-semibold text-foreground mb-3">No companies found</h3>
                    ...
                    <div className="mt-16 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl p-8">
                        <div className="text-center">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                                ...
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-primary mb-1">
                                        {filteredManufacturers.reduce((total, m) => total + m.categories.length, 0)}
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        Product Categories
                                    </div>
                                ...
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-primary mb-1">
                                        {filteredManufacturers.reduce((total, m) => total + m.categories.reduce((catTotal, cat) => catTotal + cat.productCount, 0), 0)}
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        Total Products
                                    </div>
                ...
                <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-relaxed">
                            Industry-leading technology for optimal equipment performance and significant cost savings
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="text-center p-8 rounded-2xl bg-white/70 backdrop-blur-sm border border-white/20 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                            ...
                            <h3 className="font-bold text-foreground mb-4 text-lg">Real-time Monitoring</h3>
                            <p className="text-muted-foreground leading-relaxed mb-4">
                                Continuous oil condition analysis with molecular-level detection and instant alerts for optimal performance
                            </p>
                        ...
                        <div className="text-center p-8 rounded-2xl bg-white/70 backdrop-blur-sm border border-white/20 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                            ...
                            <h3 className="font-bold text-foreground mb-4 text-lg">Predictive Maintenance</h3>
                            <p className="text-muted-foreground leading-relaxed mb-4">
                                Forecast maintenance needs and extend equipment life with AI-powered data-driven insights
                            </p>
                        ...
                        <div className="text-center p-8 rounded-2xl bg-white/70 backdrop-blur-sm border border-white/20 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                            ...
                            <h3 className="font-bold text-foreground mb-4 text-lg">Significant Cost Reduction</h3>
                            <p className="text-muted-foreground leading-relaxed mb-4">
                                Reduce maintenance costs by 40-60% and extend oil life through precise monitoring and optimization
                            </p>
                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                            ...
                            <p className="text-muted-foreground text-sm">
                                Our solutions are trusted by Fortune 500 companies and have received multiple industry awards for innovation and reliability.
                            </p>
                        </div>
                        <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                            <h4 className="font-semibold text-foreground mb-3 flex items-center">
                            ...
                            <p className="text-muted-foreground text-sm">
                                All products meet international safety standards and environmental regulations, ensuring peace of mind for your operations.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-5xl mx-auto">
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-primary/80 p-12 text-center text-white">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto leading-relaxed">
                                Contact our experts to find the perfect oil conditioning solution for your application. 
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-muted-foreground mb-6">
                            Want to see our solutions in action? Explore our application examples
                        </p>
                        <Link
                            href="/applications"
