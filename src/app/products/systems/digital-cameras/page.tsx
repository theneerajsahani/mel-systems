                ...
                <div className="py-8">
                    <div className="mb-8">
                        ...
                        <p className="text-lg text-muted-foreground">
                            Advanced digital camera systems with high-resolution imaging and intelligent 
                            features for professional vehicle monitoring applications.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <Link href="/products/systems/digital-cameras/mcdb7000a">
                            <ProductCard
                                image='/products/systems/Motec/Digital camera/MCDB7000A/MCDB7000A.jpg'
                                name='MCDB7000A'
                            />
                        </Link>
                        <Link href="/products/systems/digital-cameras/mcde3000">
                            <ProductCard
                                image='/products/systems/Motec/Digital camera/MCDE3000/MCDE3000.jpg'
                                name='MCDE3000'
                            />
                        </Link>
                        <Link href="/products/systems/digital-cameras/mcdl7000a">
                            <ProductCard
                                image='/products/systems/Motec/Digital camera/MCDL7000A/MCDL7000A.jpg'
                                name='MCDL7000A'
                            />
                        </Link>
                        <Link href="/products/systems/digital-cameras/mcde7000a">
                            <ProductCard
                                image='/products/systems/Motec/Digital camera/MCDE7000A/MCDE7000A.jpg'
                                name='MCDE7000A'
                            />
                        </Link>
                        <Link href="/products/systems/digital-cameras/mcde5200">
                            <ProductCard
