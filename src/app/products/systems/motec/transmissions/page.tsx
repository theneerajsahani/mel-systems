        ...
        <div className="py-8">
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Video transmission equipment and specialized cables for robust
              signal transmission in industrial environments with wireless and
              wired solutions.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                <Link href="/products/systems/motec/transmissions/mvrd1100">
                  <ProductCard
                    image="/products/systems/Motec/Transmission/MVRD1100/MVRD1100.jpg"
                    name="MVRD1100"
                  />
                </Link>
                <Link href="/products/systems/motec/transmissions/mab2000">
                  <ProductCard
                    image="/products/systems/Motec/Transmission/MAB2000/MAB2000.jpg"
                    name="MAB2000"
                  />
                </Link>
                <Link href="/products/systems/motec/transmissions/mvr5200">
                  <ProductCard
                    image="/products/systems/Motec/Transmission/MVR5200/MVR5200.jpg"
                    name="MVR5200"
                  />
                </Link>
                <Link href="/products/systems/motec/transmissions/mtp-vs-ve">
                  <ProductCard
