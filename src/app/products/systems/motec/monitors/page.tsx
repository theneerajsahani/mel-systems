        ...
        <div className="py-8">
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              High-quality LCD monitors designed for vehicle and industrial
              applications with rugged construction and excellent visibility in
              all conditions.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            <Link href="/products/systems/motec/monitors/md3071a-7-monitor">
              <ProductCard
                image="/products/systems/Motec/Monitors/MD3071A/MD3071A.jpg"
                name="MD3071A"
              />
            </Link>
            <Link href="/products/systems/motec/monitors/md3073">
              <ProductCard
                image="/products/systems/Motec/Monitors/MD3073/MD3073.jpg"
                name="MD3073"
              />
            </Link>
            <Link href="/products/systems/motec/monitors/md3100">
              <ProductCard
                image="/products/systems/Motec/Monitors/MD3100/MD3100.jpg"
                name="MD3100"
              />
            </Link>
            <Link href="/products/systems/motec/monitors/17-zoll-lcd-monitor">
              <ProductCard
                image="/products/systems/Motec/Monitors/17 Zoll LCD Monitor/17 Zoll LCD Monitor.jpg"
                name="17 Zoll LCD Monitor"
              />
            </Link>
            <Link href="/products/systems/motec/monitors/md4074-quad-ip30-ip67-heavy-duty-monitor">
              <ProductCard
