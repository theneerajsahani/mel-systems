                ...
                <div className="py-8">
                    <div className="mb-8">
                        ...
                        <p className="text-lg text-muted-foreground">
                            Advanced front-facing camera system for enhanced forward visibility and 
                            safety in industrial vehicles and heavy machinery operations.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <Link href="/products/systems/front-camera-system/mc3050b-4-vkms">
                            <ProductCard
