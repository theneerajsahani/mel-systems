            ...
            <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto">
                ...
                <div className="py-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <Link href="/products/systems/digital-monitors/mdde1072">
                            <ProductCard
                                image='/products/systems/Motec/Digital Monitors/MDDE1072/MDDE1072.jpg'
                                name='MDDE1072'
                            />
                        </Link>
                        <Link href="/products/systems/digital-monitors/mdde1102">
                            <ProductCard
                                image='/products/systems/Motec/Digital Monitors/MDDE1102/MDDE1102.jpg'
                                name='MDDE1102'
                            />
                        </Link>
                        <Link href="/products/systems/digital-monitors/mdde1122">
                            <ProductCard
