                ...
                <div className="py-8">
                    <div className="mb-8">
                        ...
                        <p className="text-lg text-muted-foreground">
                            Specialized cameras designed for forklift and material handling equipment 
                            to provide enhanced visibility and safety during lifting operations.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <Link href="/products/systems/fork-cameras/mc9000">
                            <ProductCard
                                image='/products/systems/Motec/Fork Camera/MC9000/MC9000.jpg'
                                name='MC9000'
                            />
                        </Link>
                        <Link href="/products/systems/fork-cameras/mc9150b">
                            <ProductCard
                                image='/products/systems/Motec/Fork Camera/MC9150B/MC9150B.jpg'
                                name='MC9150B'
                            />
                        </Link>
                        <Link href="/products/systems/fork-cameras/mc9250">
                            <ProductCard
                                image='/products/systems/Motec/Fork Camera/MC9250/MC9250.jpg'
                                name='MC9250'
                            />
                        </Link>
                        <Link href="/products/systems/fork-cameras/mc925c">
                            <ProductCard
