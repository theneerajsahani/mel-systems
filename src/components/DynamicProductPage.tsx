...
export default function DynamicProductPage({
  ...
  const breadcrumbItems = buildBreadcrumbsFromSlugPath(
    productData.slugPath || [],
  );
    ...
    <ProductLayout breadcrumbItems={breadcrumbItems}>
      ...
      <div className="mb-8">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          <Badge
            variant="secondary"
            className="bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border-blue-200"
          >
            {productData.brand}
          </Badge>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 lg:p-8">
            ...
            {productData.images && productData.images.length > 1 && (
              <div className="flex gap-4 overflow-x-auto pb-4 pt-2 px-6 scrollbar-hide">
                {productData.images.map((image, index) => (
                  <div key={index} className="flex-shrink-0 relative p-1">
                    <button
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="space-y-4 max-w-md mx-auto">
                ...
                <Button
                  variant="outline"
                  className="w-full hover:bg-gray-50 btn-scale focus-ring"
                >
      ...
      {productData.additionalSections &&
        productData.additionalSections.length > 0 && (
      ...
      {(productData.technicalSpecs || productData.orderCodes) && (
        <Card className="shadow-lg border-0 overflow-hidden">
          <CardContent className="p-0">
            ...
            {productData.technicalSpecs && (
              <TechnicalSpecsTable
                sections={productData.technicalSpecs}
                title=""
              />
            )}
