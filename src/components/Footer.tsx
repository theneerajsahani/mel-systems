...
export default function Footer() {    return (
        <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden" role="contentinfo">
            {/* Background Pattern */}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent" />
              <div className="relative mx-auto max-w-screen-2xl px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20 py-12 sm:py-16 md:py-20 lg:py-24">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-12">                    {/* Logo Section */}
                    <div className="space-y-6 md:col-span-1">
                        <div className="space-y-3">
                            ...
                            <p className="text-sm sm:text-base text-slate-300 leading-relaxed">{FOOTER_DATA.company.tagline}</p>
                        </div>
                    </div>

                    {/* Quick Links Section */}
                    <nav className="space-y-4" aria-labelledby="quick-links-heading">
                        <h4 id="quick-links-heading" className="text-base font-semibold text-white uppercase tracking-wider">
                            QUICK LINKS
                        </h4>
                    ...
                    <nav className="space-y-4" aria-labelledby="products-heading">
                        <h4 id="products-heading" className="text-base font-semibold text-white uppercase tracking-wider">
                            PRODUCTS
                        </h4>
                        <ul className="space-y-3">
                    ...
                    <nav className="space-y-4" aria-labelledby="applications-heading">
                        <h4 id="applications-heading" className="text-base font-semibold text-white uppercase tracking-wider">
                            APPLICATIONS
                        </h4>
                        <ul className="space-y-3">
                ...
                <div className="mt-12 sm:mt-16 pt-8 sm:pt-10 border-t border-slate-700/50">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
                        ...
                        <nav className="flex flex-col xs:flex-row gap-3 xs:gap-6 text-xs sm:text-sm" aria-label="Legal links">
