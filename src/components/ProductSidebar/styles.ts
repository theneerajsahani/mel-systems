export const SIDEBAR_STYLES = {
  desktop: "hidden lg:block w-full bg-white border-r border-gray-200 p-4 max-h-screen overflow-y-auto",
  ...
  mobilePanel: "fixed inset-y-0 left-0 w-80 bg-white border-r border-gray-200 shadow-lg overflow-y-auto",
  ...
  expandButton: "ml-2 p-1 hover:bg-gray-200 rounded transition-colors flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1",
