...
export const NavigationItemComponent = memo<NavigationItemProps>(
  ({
    ...
    const isParentOfActive =
      hasChildren && isItemOrChildrenActive(item, slugPath, currentSlugPath);
    ...
    const getItemStyles = () => {
      const levelStyle =
        SIDEBAR_STYLES.navigationItem.level[
          level as keyof typeof SIDEBAR_STYLES.navigationItem.level
      ...
      const stateStyles = [
        ...
        isParentOfActive &&
          !isActive &&
          SIDEBAR_STYLES.navigationItem.states.parentOfActive,
      ]
        .filter(Boolean)
        .join(" ");
      return cn(SIDEBAR_STYLES.navigationItem.base, levelStyle, stateStyles);
    };
