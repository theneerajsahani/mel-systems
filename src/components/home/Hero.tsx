...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col px-[64px] items-center justify-center min-h-[50vh] md:min-h-[70vh] lg:min-h-[80vh]">
      ...
      <div className="relative z-10 max-w-screen-xl w-full flex flex-col items-start justify-center gap-4">
        <h1 className="text-[20px] md:text-[32px] lg:text-[48px] font-bold text-white">Machinery Extended Life</h1>
