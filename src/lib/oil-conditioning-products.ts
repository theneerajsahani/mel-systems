...
export const oqsxG2OilQualitySensorData: ProductData = {
  ...
  technicalSpecs: [
    ...
    {
      title: "CONNECTORS",
      specs: [{ label: "Connector", value: "6-Pin Bulgin PXP4013/06P/PC" }],
    },
    {
      title: "ELECTRICAL",
      specs: [
    ...
    },
    {
      ...
      specs: [
        {
          label: "Output",
          value: "Tan Delta Number (TDN) Oil Temperature (C or F)",
        },
      ...
      specs: [
        {
          label: "Configuration",
          value:
            "Any mineral, semi-synthetic or synthetic oil, including fuels (diesel & bio-diesel)",
        },
      ],
    },
    {
      ...
      specs: [
        {
          ...
          value: "-40°C (-40°F) to +120°C (+248°F)",
        },
        {
          label: "Calibrated temperature",
          value: "-20°C (-4°F) to +120°C (+248°F)",
        },
        {
        ...
        { label: "Fluid pressure", value: "Up to 70 bar (1015 psi)" },
        {
          ...
          value: "-55°C (-67°F) to +150°C (+302°F)",
        },
      ],
    },
    {
      ...
      specs: [
        ...
        {
          label: "Shock and vibration",
          value:
            "BS EN 60068-2-30 (Test Db - Cyc.Hum.) BS EN 60068-2-6 (Test Fc - Sine Vib.) BS EN 60068-2-27 (Test Ea - Mech. Shock)",
        },
        {
          label: "EMC",
          value:
            "EN 61000-6-4:2007 (Generic Emissions Standard for Industrial Environments) EN 61000-6-2:2005 (Generic Immunity Standard for Industrial Environments)",
        },
...
export const oqsxG2HAZOilQualitySensorData: ProductData = {
  ...
  technicalSpecs: [
    ...
    },
    {
      ...
      specs: [
        {
          label: "Glanded integral cable",
          value: "10m as standard (350 max possible)",
        },
      ],
    },
    {
      ...
      specs: [
        {
          label: "Configuration",
          value:
            "Any mineral, semi-synthetic or synthetic oil, including fuels (diesel and bio-diesel)",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      specs: [
        ...
        {
          label: "Ex compliance standards",
          value: "BS EN IEC 60079-0:2018 BS EN 60079-11:2012",
        },
        {
          label: "Ex certification options",
          value: "Intrinsically safe order codes",
        },
        { label: "Conformity", value: "CE Marked RoHS Compliant" },
      ],
    },
  ...
  technicalSpecs: [
    ...
    },
    {
      ...
      specs: [
        ...
        {
          label: "Handle",
          value: "Single, fold-down, rubber over-moulded handle.",
        },
        {
          label: "Features",
          value:
            "Automatic pressure equalisation valve, rubber fibre washer seal, solid wall design, scratch resistant.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      specs: [
        ...
        { label: "Minimum space", value: "100Mb" },
        {
          ...
          value: "Optional for application and database updates",
        },
      ],
    },
    {
      ...
      specs: [
        ...
        },
        {
          label: "EMC",
          value:
            "EN 61000-6-4:2007 (Generic Emissions Standard for Industrial Environments) EN 61000-6-2:2005 (Generic Immunity Standard for Industrial Environments) EN 61000-6-2:2007 (Generic Immunity Standard for Industrial Environments)",
        },
        {
          label: "Case protection",
          value: "Waterproof, Crush-proof, Dust-proof, Corrosion-proof.",
        },
        {
          label: "Case certification",
          value: "IP67, Stanag 4280/ Defstan 81-41, MIL C-1450J, ATA",
        },
      ],
    },
  ],
  ...
  technicalSpecs: [
    ...
    },
    {
      ...
      specs: [
        ...
        {
          label: "Data Download",
          value: "Via WiFi using any internet-enabled device",
        },
      ...
      specs: [
        {
          ...
          value:
            "+/RS485, 9600 baud half duplex to sensor +/RS485, 115200 baud half duplex from display",
        },
    ...
    },
    {
      ...
      specs: [
        ...
        },
        {
          label: "EMC",
          value:
            "EN 61000-6-4:2007 (Generic Emissions Standard for Industrial Environments) EN 61000-6-2:2007 (Generic Immunity Standard for Industrial Environments) EN 300 328 v1.8.1 (Electromagnetic compatibility and Radio spectrum Matters (ERM); Wideband Data Transmission Equipment operating in the 2,4GHz ISM Band and using Wideband Modulation Techniques.)",
        },
        { label: "Conformity", value: "CE Marked RoHS Compliant" },
      ],
    },
  ...
  technicalSpecs: [
      ...
      specs: [
        {
          label: "GSM",
          value:
            "GSM 850 + 900B 1800 + 1900MHz + 2G\nQuad GPRS + EDGE + 3G\nClass 1 (1W) + EDGE + 3G\nGSM Max EDGE",
        },
        {
          label: "GPRS",
          value:
            "GPRS Class B, Class B (Class B)\nSMS MT, MO, Text, PST\nSMS GST + SG2\nOptional Carrier IDS and LTE via support",
        },
      ],
    },
    {
      ...
      specs: [
        ...
        { label: "Accuracy", value: "2.5 meters CEP" },
        {
          ...
          value:
            "Cold Start: 35 sec. Warm Start: 28 sec.\nHot start: < 1 sec\nTracking sensitivity: < 160 dBm",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      specs: [
        {
          label: "Storage Temperature",
          value: "-40°C (-40°F) to +85°C (+185°F)",
        },
        {
          label: "Operating Temp Off",
          value: "-30°C (-22°F) to +70°C (+158°F)",
        },
        { label: "Operating GSM On", value: "-30°C (-22°F) to +60°C (+140°F)" },
        {
          label: "Li-Ion Battery",
          value:
            "-20°C to +50°C (+14°F to +122°F) (recommended 0°C to +40°C, +32°F to +104°F)",
        },
      ],
    },
    {
      ...
      specs: [
        {
          label: "GSM",
          value:
            "GSM 850 + 900/900 + 1800/1900 + 2G/900MHz\nQuad GPRS + EDGE + 3G\nClass 1 (1W) + EDGE + 3G\nGSM Max EDGE",
        },
        {
          label: "GPRS",
          value:
            "GPRS Class B, Class B (8+1/5+2)\nSMS MT, MO, Class 1 (5V)\nSMS SMT + MO2\nOptional Carrier 100 and LTE via support",
        },
      ],
    },
    {
  ...
  technicalSpecs: [
    ...
    },
    {
      ...
      specs: [
        { label: "Analog Output", value: "1 x 4-20mA" },
        {
          label: "",
          value:
            "Digital Output: +/RS485, 9600 baud half duplex to sensor\n+/RS485, 115200 baud half duplex from display",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      specs: [
        {
          label: "Water & Dust",
          value: "IP67 when connected BS EN 60529:1992+A2:2013",
        },
        {
          label: "Shock & Vibration",
          value:
  ...
  technicalSpecs: [
    ...
    },
    {
      ...
      specs: [
        ...
        {
          label: "Dimensions ex cables",
          value: "114mm x 55mm x 16mm (L x W x H)",
        },
    ...
    {
      title: "POWER",
      specs: [{ label: "Supply", value: "9-30V" }],
    },
    {
      title: "CONNECTIONS",
      specs: [
    ...
    {
      title: "STANDARDS & CERTIFICATION",
      specs: [{ label: "Conformity", value: "CE, UKCA, RoHS Compliant" }],
    },
  ],
    ...
    },
    {
      ...
      specs: [
        ...
        { label: "Weight", value: "315g" },
        {
          label: "Thread",
          value:
            '1/2" BSPP or 1/2" NPT available, depending on Sensor thread type',
        },
      ],
    },
  ],
    ...
    additionalSections: [
      {
        title: "Product Ranges",
        content:
          "PRODUCT_GRID:watchlog-bluetooth-sensors-gauges-and-mobile-apps-products",
      },
    ],
    slugPath: [
      "oil-conditioning",
    ...
    additionalSections: [
      {
        title: "Product Ranges",
        content:
          "PRODUCT_GRID:watchlog-bluetooth-pressure-temperature-sensors-gauges-and-app-for-up-to-4-sensors-connected-simultaneously-products",
      },
    ],
    slugPath: [
      "oil-conditioning",
  ...
  additionalSections: [
    {
      ...
      content:
        "The WLB-PT supports iOS and Android Bluetooth apps. Once connected, the app can be used to display pressure values, start/stop logging, and export CSV test files. See more in our overview video.",
  ...
  additionalSections: [
    {
      title: "Watchlog Bluetooth App",
      content:
        "The WLPB-DDPG supports iOS and Android Bluetooth apps. Once connected, the app can be used to display pressure values, start/stop logging, and export CSV test files. See more in our overview video.",
      videoEmbedUrl: "https://youtu.be/ZsVAlXbAL2M",
    },
  ],
  slugPath: [
    ...
    additionalSections: [
      {
        title: "Watchlog Bluetooth App",
        content:
          "The WLPB-DDPG supports iOS and Android Bluetooth apps. Once connected, the app can display pressure values, start/stop logging, and export CSV test files. See more in our overview video.",
        videoEmbedUrl: "https://youtu.be/ZsVAlXbAL2M",
      },
    ],
    slugPath: [
...
export const wlbDpgSeriesBluetoothPressureGaugeData: ProductData = {
  ...
  technicalSpecs: [
    ...
    {
      title: "ACCURACY",
      specs: [{ label: "Accuracy", value: "0.2% FS" }],
    },
    {
      title: "OPERATING TEMPERATURE",
      specs: [{ label: "Operating Temperature", value: "-20...65°C" }],
    },
    {
      title: "POWER SUPPLY VOLTAGE",
      specs: [{ label: "Power supply voltage", value: "3V (2x AA batteries)" }],
    },
    {
      title: "PRESSURE UNIT",
      specs: [
        {
          label: "Pressure unit",
          value: "MPa, bar, kgf, mH2O, PSI, kPa, mmHg, mBAR, mmH2O, Pa, inWC",
        },
      ],
    },
    {
      title: "PROTECTION LEVEL",
      specs: [{ label: "Protection level", value: "IP54" }],
    },
  ],
  slugPath: [
    "oil-conditioning",
...
export const ddpgSeriesBluetoothPressureGaugeTestKitData: ProductData = {
  ...
  orderCodes: {
    ...
    description:
      "Replace XX with the code for the required pressure gauge range",
    options: [
      {
  ...
  additionalSections: [
    ...
    },
    {
      ...
      content:
        "As well as the included internal datalogging facility, the WLPB-DDPG supports iOS and Android Bluetooth apps. Once connected, the app can display pressure values, start/stop logging, and export CSV test files. See more in our overview video.",
      videoEmbedUrl: "https://youtu.be/ZsVAlXbAL2M",
    },
  ],
  slugPath: [
...
export const dgpSeriesBluetoothPressureGaugeTestKitData: ProductData = {
  ...
  additionalSections: [
    ...
    },
    {
      ...
      content:
        "The WLPB-DPG supports iOS and Android Bluetooth apps. Once connected, the app can display pressure values, start/stop logging, and export CSV test files. See more in our overview video.",
      videoEmbedUrl: "https://youtu.be/ZsVAlXbAL2M",
    },
  ],
  slugPath: [
    ...
    additionalSections: [
      {
        title: "Product Ranges",
        content:
          "PRODUCT_GRID:watchlog-bluetooth-plus-pressure-level-force-sensors-and-app-for-up-to-12-connected-sensors-advanced-app-calculation-features-products",
      },
    ],
    slugPath: [
      "oil-conditioning",
...
export const htWlbpWatchlogBluetoothPlusPressureSensorData: ProductData = {
  ...
  orderCodes: {
    ...
    description:
      "Replace XXXX with pressure range, Y with connector type, and ZZ with cable length.",
    options: [
      {
        label: "Pressure range",
        choices: [
...
export const htWlbllWatchlogBluetoothPlusCompressionLoadLinkData: ProductData =
  {
    ...
    orderCodes: {
      ...
      description:
        "Replace XXX with load capacity (tonnes) and Z.Z with cable length.",
      options: [
        {
    ...
    additionalSections: [
      {
        title: "Product Ranges",
        content:
          "PRODUCT_GRID:watchlog-wireless-pressure-temperature-and-flow-sensors-products",
      },
    ],
    slugPath: [
      "oil-conditioning",
...
export const watchlogWirelessPressureFlowTemperatureTestKitData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Pressure, Flow & Temperature Test Kit/Watchlog Wireless Pressure, Flow & Temperature Test Kit.png",
      alt: "Watchlog Wireless Pressure, Flow & Temperature Test Kit",
    },
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Pressure, Flow & Temperature Test Kit/Watchlog Wireless Pressure, Flow & Temperature Test Kit-1.png",
      alt: "Watchlog Wireless Pressure, Flow & Temperature Test Kit",
    },
  ],
  ...
  orderCodes: {
    ...
    description:
      "Select at least one and up to four sensors of your choice to configure your kit. Replace up to 4 Xs in the order code with your selections below.",
    options: [
      {
...
export const watchlogWirelessVisionData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Vision/Watchlog Wireless Vision-3.png",
      alt: "Watchlog Wireless Vision",
    },
  ],
  additionalSections: [
    {
...
export const watchlogAtexWirelessPressureSensorsData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog ATEX Wireless Pressure Sensors/Watchlog ATEX Wireless Pressure Sensors.png",
      alt: "Watchlog ATEX Wireless Pressure Sensors",
    },
  ],
  description: [
  ...
  orderCodes: {
    ...
    description:
      "Replace XXXX with pressure range, Y with connector type, and Z.Z with cable length.",
    options: [
      {
        ...
        choices: [
          ...
          {
            range:
              "2xD battery powered or 5...18Vdc externally powered. Requires cabling option (cannot be sensor mounted).",
            code: "DD",
          },
        ],
      },
...
export const watchlogWirelessPressureSensorsData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Pressure Sensors/Watchlog Wireless Pressure Sensors.png",
      alt: "Watchlog Wireless Pressure Sensors",
    },
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Pressure Sensors/Watchlog Wireless Pressure Sensors-1.png",
      alt: "Watchlog Wireless Pressure Sensors",
    },
  ],
  description: [
  ...
  orderCodes: {
    ...
    description:
      "Replace ** with transmitter type, XXXX with pressure range, Y with connector type (leave blank if no cable required), and Z.Z with cable length (leave blank if no cable required).",
    options: [
      {
        label: "Transmitter type",
        choices: [
...
export const watchlogWirelessTemperatureSensorsData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Temperature Sensors/Watchlog Wireless Temperature Sensors.png",
      alt: "Watchlog Wireless Temperature Sensors",
    },
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Temperature Sensors/Watchlog Wireless Temperature Sensors-1.png",
      alt: "Watchlog Wireless Temperature Sensors",
    },
  ],
  description: [
  ...
  orderCodes: {
    ...
    description:
      "Replace ** with transmitter type, XXXX with temperature range, Y with connector type (leave blank if no cable required), and Z.Z with cable length (leave blank if no cable required).",
    options: [
      {
        label: "Transmitter type",
        choices: [
...
export const watchlogWirelessLinearPositionSensorData: ProductData = {
  ...
  images: [
    {
      src: "public\products\oil conditioning\Hydrotechnik\Watchlog Wireless Pressure, Temperature and Flow Sensors\Watchlog Wireless Linear Position Sensor\Watchlog Wireless Linear Position Sensor.png",
      alt: "Watchlog Wireless Linear Position Sensor",
    },
  ],
  description: [
  ...
  orderCodes: {
    ...
    description:
      "Replace ** with transmitter type, XXX with stroke length, R with cable exit, and Z.Z with cable length.",
    options: [
      {
        label: "Transmitter type",
        choices: [
...
export const watchlogWirelessTurbineFlowMetersData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Turbine Flow Meters/Watchlog Wireless Turbine Flow Meters.png",
      alt: "Watchlog Wireless Turbine Flow Meters",
    },
  ],
  description: [
  ...
  orderCodes: {
    baseCode: "RN3/XX",
    description:
      "See table for order code, flow rate, K factor, thread size, length, diameter, and weight.",
    options: [
      {
        ...
        choices: [
          {
            range:
              'Flow rate: 1-10 Ltr/min, K factor: 5000 pulses/litre, Thread size: 3/8" BSP, Length: 82.6 mm, Diameter: 38.0 mm, Weight: 0.3 kg',
            code: "RN3/10",
          },
          {
            range:
              'Flow rate: 2-20 Ltr/min, K factor: 3800 pulses/litre, Thread size: 1/2" BSP, Length: 82.6 mm, Diameter: 50.0 mm, Weight: 0.5 kg',
            code: "RN3/15",
          },
          {
            range:
              'Flow rate: 5-50 Ltr/min, K factor: 1080 pulses/litre, Thread size: 3/4" BSP, Length: 82.6 mm, Diameter: 50.0 mm, Weight: 0.5 kg',
            code: "RN3/20/5",
          },
          {
            range:
              'Flow rate: 8-80 Ltr/min, K factor: 1080 pulses/litre, Thread size: 3/4" BSP, Length: 82.6 mm, Diameter: 50.0 mm, Weight: 0.5 kg',
            code: "RN3/20/8",
          },
          {
            range:
              'Flow rate: 15-150 Ltr/min, K factor: 620 pulses/litre, Thread size: 1" BSP, Length: 90.5 mm, Diameter: 63.5 mm, Weight: 1.0 kg',
            code: "RN3/25/15",
          },
          {
            range:
              'Flow rate: 25-250 Ltr/min, K factor: 362 pulses/litre, Thread size: 1" BSP, Length: 90.5 mm, Diameter: 63.5 mm, Weight: 0.8 kg',
            code: "RN3/25",
          },
          {
            range:
              'Flow rate: 45-450 Ltr/min, K factor: 111 pulses/litre, Thread size: 1 1/4" BSP, Length: 110.0 mm, Diameter: 75.0 mm, Weight: 1.6 kg',
            code: "RN3/32",
          },
          {
            range:
              'Flow rate: 67-670 Ltr/min, K factor: 82 pulses/litre, Thread size: 1 1/2" BSP, Length: 116.7 mm, Diameter: 76.2 mm, Weight: 1.7 kg',
            code: "RN3/40",
          },
          {
            range:
              'Flow rate: 110-1100 Ltr/min, K factor: 59 pulses/litre, Thread size: 2" BSP, Length: 154.0 mm, Diameter: 89.0 mm, Weight: 3.1 kg',
            code: "RN3/50",
          },
          {
            range:
              'Flow rate: 225-2250 Ltr/min, K factor: 19 pulses/litre, Thread size: 3" BSP, Length: 170.0 mm, Diameter: 95.0 mm, Weight: 3.5 kg',
            code: "RN3/65",
          },
        ],
      },
...
export const watchlogWirelessOvalGearFlowMetersData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Oval Gear Flow Meters/Watchlog Wireless Oval Gear Flow Meters.png",
      alt: "Watchlog Wireless Oval Gear Flow Meters",
    },
  ],
  description: [
  ...
  additionalSections: [
    {
      ...
      content: `Power supply: USB (4.875 to 5.125 Vdc)
        <br/>
        Wireless range: 500m
        <br/>
        <br/>
...
export const wlwArWirelessSignalExtenderData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/WLW-AR Wireless Signal Extender/WLW-AR Wireless Signal Extender.png",
      alt: "WLW-AR Wireless Signal Extender",
    },
  ],
  description: [
...
export const watchlogWirelessSignalGatewayModulesData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Signal Gateway Modules/Watchlog Wireless Signal Gateway Modules.png",
      alt: "Watchlog Wireless Signal Gateway Modules",
    },
  ],
  description: [
...
export const watchlogWirelessConfigMonitoringLoggingSoftwareData: ProductData =
  {
    ...
    images: [
      {
        src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Configuring, Monitoring & Logging Software/Watchlog Wireless Configuring, Monitoring & Logging Software.png",
        alt: "Watchlog Wireless Configuring, Monitoring & Logging Software",
      },
    ],
    description: [
...
export const watchlogWirelessAccessoriesData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/Watchlog Wireless Accessories/Watchlog Wireless Accessories.png",
      alt: "Watchlog Wireless Accessories",
    },
  ],
  description: [
...
export const wlwplSeriesCellularLevelSensorData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Wireless Pressure, Temperature and Flow Sensors/WLWPL Series Cellular Level Sensor/WLWPL Series Cellular Level Sensor.png",
      alt: "WLWPL Series Cellular Level Sensor",
    },
  ],
  description: [
...
export const watchlogProRemoteMonitoringCategoryData: ProductData = {
  ...
  images: [
    {
      src: "public/products/oil conditioning/Hydrotechnik/Watchlog Pro Remote Monitoring/Watchlog Pro Remote Monitoring.png",
...
export const filtertechnikCategoryData: ProductData = {
  ...
  categoryProductIds: ["s120-digital-imaging-particle-counter", "particle-pal"],
    ...
    },
    {
      ...
      specs: [
        { label: "IP Rating", value: "IP65" },
        {
          ...
          value:
            "Mineral oils, synthetic oils, diesel, glycol, water, phosphate ester fluids possible – please contact us for more information.",
        },
    ...
    },
    {
      ...
      specs: [
        { label: "Protocols", value: "Modbus TCP (RS485)" },
        {
          ...
          value: "Relay output, local panel indicator, local output indicator",
        },
      ],
    },
  ],
        ...
        specs: [
          {
            label: "Fluid Compatibility",
            value:
              "Synthetic Oils, Organic Oils, Mineral Oils & Diesel Fuel (2,400 cSt viscosity limit)",
          },
          {
            label: "Display Information",
            value:
              "Particulate: ISO 4406, SAE AS4059 & NAS 1638, bubble elimination and particulate wear analysis. Water: Relative Humidity (RH%). Oil Condition: Utilises Tan Delta's oil life sensor to determine the remaining life of any oil profiled.",
          },
          {
            label: "Modes of Operation",
            value:
              "High Pressure live system sampling (up to 350 bar) - via a high pressure adaptor. Bottle sampling and Tank sampling.",
          },
          {
            label: "Data",
            value:
              "All data stored locally and backed up off-site. Export to .CSV or PDF",
          },
          {
            label: "Calibration",
            value:
              "500 oils profiled with the ability to self calibrate any oil also included, via a one time routine.",
          },
        ],
      },
    ],
    ...
    technicalSpecs: [
      {
        ...
        specs: [
          ...
          },
          {
            label: "Calibration",
            value:
              "200 oils profiled with the ability to self calibrate any oil also included, via a one time routine.",
          },
        ],
      },
    ],
...
export const fs9v3OluParticlePalProLifeDigitalImagingPortableParticleCounterData: ProductData =
  {
    ...
    slugPath: [
      ...
      "filtertechnik",
      "particle-pal",
      "fs9v3-olu-particle-pal-pro-life-digital-imaging-portable-particle-counter",
    ],
  };
    ...
    additionalSections: [
      {
        ...
        content:
          "Our all new Particle Pal Plus utilises breakthrough digital imaging technology which provides a greater insight into the size and type of particulate in any oil system. Air bubble elimination and shape recognition gives root cause particle analysis. A water content sensor completes this package.",
      },
      {
        title: "FS9V4-RH",
        image: {
      ...
      },
      {
        title: "Water Sensor",
        content:
          "Water in oil is a contaminant that can contribute to microbial growth and encourage further contamination, from solids to rust. The inbuilt water sensor shows the relative humidity of any oil as % saturation for analysing oils.",
      },
      {
        title: "Water Content",
        content:
          "Displayed as % saturation (relative humidity). Helps inform whether an oil change is actually required.",
      },
      {
        title: "Particulate analysis",
        content:
          "The digital imaging particle counter gives advanced size and shape recognition for any sample. Counting particulate in fuel and virtually any oil up to 320cSt, the device also eliminates air bubbles, making it ideal for heavy lube and gear oil applications in cold temperatures. Reporting 4, 6, 14, 21, 38 & 70 micron counts as well as categorising any particle greater than 20 microns into Fatigue Wear, Sliding Wear, Cutting Wear and Fibres.",
      },
    ],
    technicalSpecs: [
      {
        ...
        specs: [
          {
            label: "Fluid Compatibility",
            value:
              "Synthetic Oils, Organic Oils, Mineral Oils & Diesel Fuel (320 cSt viscosity limit)",
          },
          {
            label: "Display Information",
            value:
              "Particulate: ISO 11171, SAE AS4059 & NAS 1638, bubble elimination and particulate wear analysis. Water sensing: Water is displayed as relative humidity (RH) % saturation.",
          },
          {
            label: "Modes of Operation",
            value:
          ...
          },
          {
            label: "Data",
            value:
              "All data stored locally with an option to export to CSV or PDF.",
          },
        ],
      },
    ],
    ...
    additionalSections: [
      {
        ...
        content:
          "Our all new Particle Pal Plus utilises breakthrough digital imaging technology which provides a greater insight into the size and type of particulate in any fuel system. Air bubble elimination and shape recognition gives root cause particle analysis. A PPM Water sensor completes the package.",
      },
      {
        title: "FS9V4-PPM",
        image: {
    ...
    technicalSpecs: [
      {
        ...
        specs: [
          ...
          },
          {
            label: "Display Information",
            value:
              "Particulate: ISO 11171, SAE AS4059 & NAS 1638, bubble elimination and particulate wear analysis. Water sensing: Water is displayed in parts per million (PPM).",
          },
          {
            label: "Modes of Operation",
            value:
    ...
    technicalSpecs: [
      {
        ...
        specs: [
          ...
          },
          {
            label: "Display Information",
            value:
              "Particulate: ISO 11171, SAE AS4059 & NAS 1638, bubble elimination and particulate wear analysis.",
          },
          {
            label: "Modes of Operation",
            value:
    ...
    additionalSections: [
      {
        ...
        content:
          "Our all new Particle Pal Plus High Viscosity utilises breakthrough digital imaging technology providing unparalleled insight into the size and type of particulate in any oil system up to 2,400cSt. Air bubble elimination and shape recognition gives root cause particle analysis. A stepper motor pump for high viscosity oils completes this package.",
      },
      {
      ...
      },
      {
        ...
        content:
          "We've developed a fully controllable stepper motor-driven pump to deliver exact flow rates for any oil, from 1 to 2,400 cSt. The pump also allows connection to a live system up to 350bar via an optional high pressure adaptor.",
      },
      {
        title: "Battery Life",
        content:
...
export const fs9v4PpmDenParticlePalPlusWaterPPMDensitySensorDigitalImagingPortableParticleCounterData: ProductData =
  {
    ...
    technicalSpecs: [
      {
        ...
        specs: [
          {
            label: "Fluid Compatibility",
            value: "Diesel Fuel (320 cSt viscosity limit)",
          },
          {
            label: "Display Information",
            value:
              "Particulate: ISO 4406, SAE AS4059 & NAS 1638, bubble elimination and particulate wear analysis.\nWater sensing: Water is displayed in parts per million (PPM).\nDensity: Range: 0.6kg/m³ - 1.3kg/m³\nResolution: 0.001kg/m³\nAccuracy: +/- 2%",
          },
          {
            label: "Modes of Operation",
            value: "Bottle sampling and tank sampling.",
          },
          {
            label: "Data",
            value:
    ...
    slugPath: [
      ...
      "filtertechnik",
      "particle-pal",
      "fs9v4-ppm-den-particle-pal-plus-water-ppm-density-sensor-digital-imaging-portable-particle-counter",
    ],
  };
    ...
    additionalSections: [
      {
        ...
        content:
          "Our all new Particle Pal Plus high viscosity with water sensing has the same functionality as our FS9V4-RH but with an advanced stepper motor pump that can handle oils from 1cSt up to 2,400cSt. This version of the Particle Pal Plus has a larger HMI screen and larger robust case.",
      },
      {
        title: "FS9V4-PPM-DEN",
        image: {
    ...
    technicalSpecs: [
      {
        ...
        specs: [
          ...
          },
          {
            label: "Modes of Operation",
            value:
              "High pressure live system sampling (up to 350 bar) - via a high pressure adaptor.\nBottle sampling and tank sampling.",
          },
          {
            label: "Data",
            value:
...
export const fs9v4RhVdHvParticlePalPlusHighViscosityParticulateWaterRHDensityData: ProductData =
  {
    ...
    additionalSections: [
      {
        title:
          "Portable Particulate, Water, Viscosity and Density sensing for oils up to 2,400cSt",
        content:
          "This version of our Particle Pal Plus has the largest number of sensors built-in. Particulate, Water expressed as %RH (Relative Humidity) plus Viscosity and Density are all reported on a large touch screen display. Oils up to 2,400cSt can be analysed.",
      },
      {
      ...
      },
      {
        title: "Water Sensor",
        content:
          "Water in oil is a contaminant that can contribute to microbial growth and encourage further contamination, from solids to rust. The inbuilt water sensor shows the relative humidity of any oil as % saturation.",
      },
      {
        title: "Water content",
        content:
      ...
      },
      {
        ...
        content:
          "The accurate piezo electric viscometer has a measuring range of 25-400mPa.s Knowing the viscosity of your oil can help spot end of life or dilution/ topping up issues.",
      },
      {
        title: "Internal Stepper Motor Pump",
        content:
          "Stepper motor-driven pump to deliver exact flow rates for any oil, from 1 to 2,400 cSt. The pump also allows connection to a live system up to 350bar via an optional high pressure adaptor.",
      },
      {
        title: "Water content",
        content:
    ...
    slugPath: [
      ...
      "filtertechnik",
      "particle-pal",
      "fs9v4-rh-v-d-hv-particle-pal-plus-high-viscosity-particulate-water-rh-viscosity-density",
    ],
  };
  ...
  additionalSections: [
    {
      ...
      content:
        "The Smart Bubble System (SBS) offers customized solutions for all industries that rely on precise oil condition monitoring and lubrication optimization.",
    },
  ],
