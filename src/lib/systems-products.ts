...
export const mc3000bVaData: ProductData = {
    id: "mc3000b-va",
...
export const mc3000cIrWlData: ProductData = {
    id: "mc3000c-ir-wl",
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Rear View Cameras", href: "/products/systems/motec/rear-view-cameras" },
        { label: "MC3000C-IR & WL - Night Vision-Compatible Heavy-Duty Infrared Camera with Built-in Light" }
    ]
};

// Product Data - MC4000A - Heavy-duty camera
export const mc4000aData: ProductData = {
    id: "mc4000a",
...
export const mc4000aIrWlData: ProductData = {
    id: "mc4000a-ir-wl",
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Rear View Cameras", href: "/products/systems/motec/rear-view-cameras" },
        { label: "MC4000A-IR & WL - Night Vision-Compatible Heavy-Duty Infrared Camera with Built-in Light" }
    ]
};

// Product Data - MC6000D - Sturdy universal camera
export const mc6000dData: ProductData = {
    id: "mc6000d",
...
export const mc7000cSeriesData: ProductData = {
    id: "mc7000c-series",
...
export const mc7180nData: ProductData = {
    id: "mc7180n",
...
export const mc7000bMh1Data: ProductData = {
    id: "mc7000b-mh1",
    name: "MC7000B-MH1",
    category: "systems",
    subcategory: "motec",
...
export const mc7000bMh2Data: ProductData = {
    id: "mc7000b-mh2",
    name: "MC7000B-MH2",
    category: "systems",
    subcategory: "motec",
...
export const mc3050b4VkmsData: ProductData = {
    id: "mc3050b-4-vkms",
    ...
    breadcrumbItems: [
        ...
        { label: "Systems", href: "/products/systems" },
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Front Camera System", href: "/products/systems/motec/front-camera-system" },
        { label: "MC3050B-4-VKMS - Heavy-duty camera for front implements" }
    ]
};
...
export const mcdb7000aData: ProductData = {
    id: "mcdb7000a",
    ...
    breadcrumbItems: [
        ...
        { label: "Systems", href: "/products/systems" },
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Digital Camera's", href: "/products/systems/motec/digital-cameras" },
        { label: "MCDB7000A - Heavy Duty Broadr-Reach Camera" }
    ]
};

// Product Data - MCDE3000 - OEM Ethernet Camera
export const mcde3000Data: ProductData = {
    id: "mcde3000",
...
export const mcdl7000aData: ProductData = {
    id: "mcdl7000a",
...
export const mcde7000aData: ProductData = {
    id: "mcde7000a",
...
export const mcde5200Data: ProductData = {
    id: "mcde5200",
    ...
    breadcrumbItems: [
        ...
        { label: "Systems", href: "/products/systems" },
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Crane Camera's", href: "/products/systems/motec/crane-camera" },
...
export const md3071aData: ProductData = {
    id: "md3071a",
    ...
    breadcrumbItems: [
        ...
        { label: "Systems", href: "/products/systems" },
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Monitors", href: "/products/systems/motec/monitors" },
        { label: "MD3071A - 7\" Monitor" }
    ]
};

// Product Data - MD3073 - Waterproof heavy-duty monitor
export const md3073Data: ProductData = {
    id: "md3073",
...
export const md3100Data: ProductData = {
    id: "md3100",
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Monitors", href: "/products/systems/motec/monitors" },
        { label: "MD3100 - 10.2\" Monitor" }
    ]
};

// Product Data - 17 Zoll LCD Monitor
export const lcd17zollData: ProductData = {
    id: "lcd17zoll",
...
export const md4074QuadIpData: ProductData = {
    id: "md4074-quad-ip",
...
export const mdde1072Data: ProductData = {
    id: "mdde1072",
...
export const mdde1122Data: ProductData = {
    id: "mdde1122",
...
export const mc9000Data: ProductData = {
    id: "mc9000",
    ...
    breadcrumbItems: [
        ...
        { label: "Systems", href: "/products/systems" },
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Fork Camera's", href: "/products/systems/motec/fork-cameras" },
        { label: "MC9000 - Sturdy Fork Camera" }
    ]
};

// Product Data - MC9150B - Heavy-duty pinhole camera
export const mc9150bData: ProductData = {
    id: "mc9150b",
...
export const mc9250Data: ProductData = {
    id: "mc9250",
...
export const mc925cData: ProductData = {
    id: "mc925c",
...
export const mvcd2000Data: ProductData = {
    id: "mvcd2000",
    ...
    breadcrumbItems: [
        ...
        { label: "Systems", href: "/products/systems" },
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MVCD2000 - Digital Video Control Unit" }
    ]
};

// Product Data - MVCU1300
export const mvcu1300Data: ProductData = {
    id: "mvcu1300",
    name: "MVCU1300 - Video Control Unit",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MVCU1300 - Video Control Unit" }
    ]
};
...
export const mvcu1400Data: ProductData = {
    id: "mvcu1400",
    name: "MVCU1400 - Video Control Unit",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MVCU1400 - Video Control Unit" }
    ]
};
...
export const mvcu1500Data: ProductData = {
    id: "mvcu1500",
    name: "MVCU1500 - Video Control Unit",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MVCU1500 - Video Control Unit" }
    ]
};
...
export const mvcu1600Data: ProductData = {
    id: "mvcu1600",
    name: "MVCU1600 - Video Control Unit",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MVCU1600 - Video Control Unit" }
    ]
};

// Product Data - MB1205 - for two cameras
export const mb1205Data: ProductData = {
    id: "mb1205",
    name: "MB1205 - Video Control Unit for Two Cameras",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MB1205 - Video Control Unit for Two Cameras" }
    ]
};
...
export const mb1405QuadData: ProductData = {
    id: "mb1405-quad",
    name: "MB1405-Quad - Video Controller with Split Function",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MB1405-Quad - Video Controller with Split Function" }
    ]
};

// Product Data - MBE5200 - for cranes 
export const mbe5200Data: ProductData = {
    id: "mbe5200",
    name: "MBE5200 - Operator Control Module for Cranes",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MBE5200 - Operator Control Module for Cranes" }
    ]
};

// Product Data - MV13 - Video unit 
export const mv13Data: ProductData = {
    id: "mv13",
...
export const mv5201_1Data: ProductData = {
    id: "mv5201-1",
    name: "MV5201-1 - Video Control Unit",
    category: "systems",
    subcategory: "motec",
    brand: "Motec",
    images: [
    ...
    breadcrumbItems: [
        ...
        { label: "Motec", href: "/products/systems/motec" },
        { label: "Video Control Units", href: "/products/systems/motec/video-control-units" },
        { label: "MV5201-1 - Video Control Unit" }
    ]
};
...
export const mwsData: ProductData = {
  id: "mws",
...
export const mc5201Data: ProductData = {
  id: "mc5201",
...
export const mvrd1100Data: ProductData = {
  id: "mvrd1100",
  ...
  breadcrumbItems: [
    ...
    { label: "Systems", href: "/products/systems" },
    { label: "Motec", href: "/products/systems/motec" },
    { label: "Transmissions", href: "/products/systems/motec/transmissions" },
    { label: "MVRD1100 - Digital Radio System" }
  ]
};

// Product data - MAB2000 - Mobile heavy-duty battery box
export const mab2000Data: ProductData = {
  id: "mab2000",
...
export const mvr5200Data: ProductData = {
  id: "mvr5200",
...
export const mtp_vs_veData: ProductData = {
  id: "mtp-vs-ve",
...
export const mk5KabelData: ProductData = {
  id: "mk5-kabel",
  name: "MK5-cabel",
  category: "systems",
  subcategory: "motec",
...
export const mk2515ma2KabelData: ProductData = {
...
export const mk67KabelData: ProductData = {
  id: "mk67-cable",
  name: "Mk67-cable",
  category: "systems",
  subcategory: "motec",
...
export const mk84KabelData: ProductData = {
  id: "mk84-cable",
  name: "MK84-cable",
  category: "systems",
  subcategory: "motec",
...
export const mk228KabelData: ProductData = {
  id: "mk228-cabel",
  name: "MK228-cabel",
  category: "systems",
  subcategory: "motec",
...
export const mk232KabelData: ProductData = {
  id: "mk232-cabel",
  name: "MK232-cabel",
  category: "systems",
  subcategory: "motec",
...
export const mk295KabelData: ProductData = {
  id: "mk295-cabel",
  name: "MK295-cabel",
  category: "systems",
  subcategory: "motec",
...
export const mk296KabelData: ProductData = {
  id: "mk296-cabel",
  name: "MK296-cabel",
  category: "systems",
  subcategory: "motec",
...
export const systemsProductMapping: Record<string, ProductData> = {
  // Rear View Cameras
  "/products/systems/motec/rear-view-cameras/mc3000b": mc3000bData,
  "/products/systems/motec/rear-view-cameras/mc3000b-va": mc3000bVaData,
  "/products/systems/motec/rear-view-cameras/mc3000c-ir-wl": mc3000cIrWlData,
  "/products/systems/motec/rear-view-cameras/mc4000a": mc4000aData,
  "/products/systems/motec/rear-view-cameras/mc4000a-ir-wl": mc4000aIrWlData,
  "/products/systems/motec/rear-view-cameras/mc6000d": mc6000dData,
  "/products/systems/motec/rear-view-cameras/mc7000c-series": mc7000cSeriesData,
  "/products/systems/motec/rear-view-cameras/mc7180n": mc7180nData,
  "/products/systems/motec/rear-view-cameras/mc7000b-mh1": mc7000bMh1Data,
  "/products/systems/motec/rear-view-cameras/mc7000b-mh2": mc7000bMh2Data,

  // Front Camera System
  "/products/systems/motec/front-camera-system/mc3050b-4-vkms": mc3050b4VkmsData,

  // Digital Cameras
  "/products/systems/motec/digital-cameras/mcdb7000a": mcdb7000aData,
  "/products/systems/motec/digital-cameras/mcde3000": mcde3000Data,
  "/products/systems/motec/digital-cameras/mcdl7000a": mcdl7000aData,
  "/products/systems/motec/digital-cameras/mcde7000a": mcde7000aData,
  "/products/systems/motec/digital-cameras/mcde5200": mcde5200Data,

  // Monitors
  "/products/systems/motec/monitors/md3071a": md3071aData,
  "/products/systems/motec/monitors/md3073": md3073Data,
  "/products/systems/motec/monitors/md3100": md3100Data,
  "/products/systems/motec/monitors/17-zoll-lcd": lcd17zollData,
  "/products/systems/motec/monitors/md4074-quad": md4074QuadIpData,

  // Digital Monitors
  "/products/systems/motec/digital-monitors/mdde1072": mdde1072Data,
  "/products/systems/motec/digital-monitors/mdde1102": mdde1102Data,
  "/products/systems/motec/digital-monitors/mdde1122": mdde1122Data,

  // Fork Cameras
  "/products/systems/motec/fork-cameras/mc9000": mc9000Data,
  "/products/systems/motec/fork-cameras/mc9150b": mc9150bData,
  "/products/systems/motec/fork-cameras/mc9250": mc9250Data,
  "/products/systems/motec/fork-cameras/mc925c": mc925cData,

  // Video Control Units
  "/products/systems/motec/video-control-units/mvcd2000": mvcd2000Data,
  "/products/systems/motec/video-control-units/mvcu1300": mvcu1300Data,
  ...
  "/products/systems/motec/video-control-units/mb1205": mb1205Data,
  "/products/systems/motec/video-control-units/mb1405-quad": mb1405QuadData,
  "/products/systems/motec/video-control-units/mbe5200": mbe5200Data,
  "/products/systems/motec/video-control-units/mv13": mv13Data,
  "/products/systems/motec/video-control-units/mv5201-1": mv5201_1Data,

  // Crane Cameras
  "/products/systems/motec/crane-cameras/mws": mwsData,
  "/products/systems/motec/crane-cameras/mc5201": mc5201Data,
  "/products/systems/motec/crane-cameras/mcde5200": mcde5200Data,

  // Transmissions
  "/products/systems/motec/transmissions/mvrd1100": mvrd1100Data,
  "/products/systems/motec/transmissions/mab2000": mab2000Data,
  "/products/systems/motec/transmissions/mvr5200": mvr5200Data,
  "/products/systems/motec/transmissions/mtp-vs-ve": mtp_vs_veData,
  "/products/systems/motec/transmissions/mkw-kabel": mkwKabelData,
  "/products/systems/motec/transmissions/mk5-cabel": mk5KabelData,
  "/products/systems/motec/transmissions/mk25-15-ma2-cable": mk2515ma2KabelData,
  "/products/systems/motec/transmissions/mk67-cable": mk67KabelData,
  "/products/systems/motec/transmissions/mk84-cable": mk84KabelData,
  "/products/systems/motec/transmissions/mk228-cabel": mk228KabelData,
  "/products/systems/motec/transmissions/mk232-cabel": mk232KabelData,
  "/products/systems/motec/transmissions/mk295-cabel": mk295KabelData,
  "/products/systems/motec/transmissions/mk296-cabel": mk296KabelData,
};